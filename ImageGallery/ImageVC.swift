...
//        var possiblyUnique = "Item"
//        var combinedDocs: [GalleryDocument]?
//        
//        combinedDocs = documents.count > 1 ? documents[0] + documents[1] : nil
//        let sortedDocs = combinedDocs != nil ? combinedDocs!.sorted(by: { $0.ID < $1.ID }) : documents[0].sorted(by: { $0.ID < $1.ID })
